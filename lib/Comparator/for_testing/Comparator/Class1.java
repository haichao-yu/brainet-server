 ...
 * from the files:
 * <pre>
 *  C:\\Users\\Haichao\\Desktop\\Comparator.m
 * </pre>
...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    /**
     * Maintains information used in calling the <code>Comparator</code> M-function.
     */
    private static final MWFunctionSignature sComparatorSignature =
    ...
    {
        this(ComparatorMCRFactory.newInstance());
    }
    ...
    {
        this(ComparatorMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(ComparatorMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = ComparatorMCRFactory.newInstance();
            mcr.runMain( sComparatorSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>Comparator</code> M-function 
     ...
     */
    public void Comparator(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sComparatorSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Comparator(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sComparatorSignature);
    }

    /**
     * Provides the standard interface for calling the <code>Comparator</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] Comparator(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sComparatorSignature), 
                    sComparatorSignature);
        return lhs;
    }
}
